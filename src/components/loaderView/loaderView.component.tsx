...
import { ILoaderView } from './loaderView.model';
import { IVnode } from '../../viewEngin/component.model';

/**
 * loaderView.component.tsx
 * @createdOn:31-Aug-19
...
class LoaderView extends Component<ILoaderView> {
  private emitter: CustomEvents;
  constructor(props: ILoaderView) {
    super(props);
  ...
  render(): IVnode {
    ...
    return (
      <g id='smartsChartsNXT-loader-container'>
        <rect class='sc-overlay' x={0} y={0} width={(this as any).context.svgWidth} height={(this as any).context.svgHeight} opacity='0.2' fill='#000' ></rect>
        <g id='loader-icon' transform={`translate(${(this as any).context.svgWidth / 2},${((this as any).context.svgHeight / 2) - 40}) scale(0.6,0.6)`}>
