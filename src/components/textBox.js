  ...
  render() {
    return (
      <g class={this.props.class} transform={`translate(${this.props.posX},${this.props.posY})`} tabindex="-1">
        <rect x={-((this.state.textWidth/2)+this.props.padding)} y={-((this.state.textBBox.height/2)+this.props.padding)} width={this.state.textWidth+(2*this.props.padding)} height={this.state.textBBox.height+(this.props.padding)} transform={this.props.transform || ""} rx={this.props.borderRadius || 0} opacity='0.8' fill={this.props.background}></rect> 
