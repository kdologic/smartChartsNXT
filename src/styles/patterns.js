...
class Patterns {
  ...
  getType(patternName, id, fillColor = '#000') {
    switch (patternName) {
      default:
      case ENUMS.PATTERN.CIRCLE_1: return (
        <defs>
      ...
      case ENUMS.PATTERN.CIRCLE_2: return (
        <defs>
      ...
      case ENUMS.PATTERN.CIRCLE_3: return (
        <defs>
      ...
      case ENUMS.PATTERN.BACK_DIAGONAL_1: return (
        <defs>
          <pattern id={id} x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.BACK_DIAGONAL_2: return (
        <defs>
          <pattern id={id} x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.FRONT_DIAGONAL_1: return (
        <defs>
          <pattern id={id} x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.FRONT_DIAGONAL_2: return (
        <defs>
          <pattern id={id} x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.VERTICAL_1: return (
        <defs>
      ...
      case ENUMS.PATTERN.VERTICAL_2: return (
        <defs>
      ...
      case ENUMS.PATTERN.HORIZONTAL_1: return (
        <defs>
          <pattern id={id} x="0" y="0" width="5" height="5" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.HORIZONTAL_2: return (
        <defs>
          <pattern id={id} x="0" y="0" width="6" height="6" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.SQUARE: return (
        <defs>
          <pattern id={id} x="0" y="0" width="10" height="10" patternUnits="userSpaceOnUse" >
      ...
      case ENUMS.PATTERN.BOX3D: return (
        <defs>
      ...
      case ENUMS.PATTERN.SHAPE_S: return (
        <defs>
      ...
      case ENUMS.PATTERN.CHECKERBOARD: return (
        <defs>
