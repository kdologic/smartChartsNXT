    ...
    function divergeElements(){
      if(PAGE_DATA.uniqueDataSet.length >1){
        ...
        { 
          ...
          var transposePoint = polarToCartesian(PAGE_DATA.pieCenter.x,PAGE_DATA.pieCenter.y, getEllipticalRadious((PAGE_DATA.svgCenter.x*2),(PAGE_DATA.svgCenter.y*2),pieData.midAngle), pieData.midAngle) ;
