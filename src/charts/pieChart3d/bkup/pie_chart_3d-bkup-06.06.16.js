...
(function(){
  ...
  window.drawPieChart3D = function(opts)
  {
    ...
    function createPie(startAngle,endAngle,color,index)
    {
      ...
      strSVG += "  <path class='pie"+index+"' id='upperArcPie"+index+"'  fill='"+lighterShade+"' stroke='none' style='cursor:pointer;' \/>";//"+lighterShade+"'
    ...
    function bindEvents()
    {
      ...
      for(var pieIndex = 0;pieIndex < PAGE_DATA.uniqueDataSet.length;pieIndex++)
      {
        $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#upperArcPie"+pieIndex).off("click");
        $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#upperArcPie"+pieIndex).on("click", function(){
      ...
      function bindRotationEvent()
      {
        ...
        $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").off("touchmove");
        $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").on("touchmove", function(e) {
          e.preventDefault(); 
        ...
        for(var pieIndex = 0;pieIndex < PAGE_DATA.uniqueDataSet.length;pieIndex++)
        {
          ...
          for(var i=0;i<pieElems.length;i++)
          {
            ...
            if($(pieElems[i]).attr("id").match("sideB"))
            {
              ...
              //createDot(sideBUpperEdgeCenter,"black");
              //console.log("sideBpie"+pieIndex);
            ...
            }else if($(pieElems[i]).attr("id").match("sideA"))
            {
              ...
              //createDot(sideAUpperEdgeCenter,"black");
              //console.log("sideBpie"+pieIndex);
    ...
    function resetTextPos()
    {
      ...
      $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#txtTitleGrp").find("#txtTitle").attr("x",(PAGE_DATA.svgCenter.x-(titleBoundBox.width/2))).attr("y",(PAGE_DATA.svgCenter.y-(200)));
      $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#txtTitleGrp").find("#txtSubtitle").attr("x",(PAGE_DATA.svgCenter.x-(subTitleBoundBox.width/2))).attr("y",(PAGE_DATA.svgCenter.y-(175)));
      console.log(PAGE_DATA.svgCenter);
      console.log(titleBoundBox);
      for(var pieIndex = 0;pieIndex < PAGE_DATA.uniqueDataSet.length;pieIndex++)
      {
        var pieData,elemId = "pie"+pieIndex;
        for(var i=0;i<PAGE_DATA.pieSet.length;i++){
