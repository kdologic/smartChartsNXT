...
window.SmartChartsNXT.LineChart = function (opts) {
  ...
  var PAGE_CONST = {
    ...
    MIN_HEIGHT: 400,
    hGridCount: 9,
    runId: "linechart_" + Math.round(Math.random() * 1000000001)
  };
  ...
  function prepareChart() {
    ...
    var catList = [],
      scaleX = PAGE_DATA.gridBoxWidth / PAGE_OPTIONS.dataSet.series[PAGE_DATA.longestSeries].data.slice(0, PAGE_OPTIONS.dataSet.series[PAGE_DATA.longestSeries].data.length);
