(function(){
  ...
  window.drawPieChart = function(opts)
  {
    ...
    {
      if(PAGE_DATA.dragStartPoint && PAGE_DATA.dragEndPoint)
      {
    ...
    function resetOrdering()
    {
      ...
      try {
        ...
        {
          var pie = $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#"+arrPieSet[index].id);
          $("#"+PAGE_OPTIONS.targetElem).find("#pieChart3D").find("#"+arrPieSet[index].id).remove();
