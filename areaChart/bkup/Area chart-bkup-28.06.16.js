...
window.drawAreaChart = function(opts)
{
  ...
  function prepareChart()
  {
    ...
    strSVG += "<rect id='sliderLeftOffset' x='"+(PAGE_DATA.marginLeft+PAGE_DATA.scaleX)+"' y='"+((PAGE_DATA.svgCenter.y*2)-PAGE_DATA.marginBottom+PAGE_DATA.fullChartHeight)+"' width='100' height='"+(PAGE_DATA.scaleY+60)+"' style='fill:black;stroke-width:0.1;stroke:#717171;' \/>";
    strSVG += "<rect id='sliderRightOffset' x='"+(PAGE_DATA.marginLeft+PAGE_DATA.scaleX)+"' y='"+((PAGE_DATA.svgCenter.y*2)-PAGE_DATA.marginBottom+PAGE_DATA.fullChartHeight)+"' width='100' height='"+(PAGE_DATA.scaleY+60)+"' style='fill:black;stroke-width:0.1;stroke:#717171;' \/>";
  ...
  function bindSliderEvents()
  {
    document.querySelector("#"+PAGE_OPTIONS.targetElem+" #areaChart #slideLSel").addEventListener("mousedown", function(e){
      e.stopPropagation();
      //console.log("mousedown#slideLSel");
