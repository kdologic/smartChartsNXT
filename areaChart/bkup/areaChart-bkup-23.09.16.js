      ...
      (function(indx,catList,dataSet){
        ...
        if(seriesArea) seriesArea.addEventListener("mousemove", function(e){
          ...
          if(line1Start.x <  mousePointer.x)
            ...
            var line1End = PAGE_DATA.series[indx][nearestPointIndex-1];
          var line2Start = new $SC.geom.Point(mousePointer.x,(PAGE_DATA.marginTop+PAGE_DATA.gridBoxHeight));
          var line2End = new $SC.geom.Point(mousePointer.x,PAGE_DATA.marginTop);
          
          if(typeof line1Start !== "undefined" && typeof line1End !== "undefined" && typeof line2Start !== "undefined" && typeof line2End !== "undefined")
            var toolTipPoint = $SC.geom.checkLineIntersection(line1Start.x,line1Start.y,line1End.x,line1End.y,line2Start.x,line2Start.y,line2End.x,line2End.y);
          ...
          if(toolTipPoint && toolTipPoint.onLine1 === true && toolTipPoint.onLine2 === true)
          {
            ...
            $SC.geom.createDot(toolTipPoint,$SC.util.getColor(indx),3,1,"tooTipPoint","areaChart");
            $SC.geom.createDot(toolTipPoint,$SC.util.getColor(indx),8,0.2,"tooTipPoint","areaChart");
            
            var projectedVal = (PAGE_DATA.marginTop+PAGE_DATA.gridBoxHeight-toolTipPoint.y)/scaleY,toolTipRow1,toolTipRow2;
            if((toolTipPoint.x > (PAGE_DATA.series[indx][nearestPointIndex].x-5)) && (toolTipPoint.x < (PAGE_DATA.series[indx][nearestPointIndex].x+5)) ){
              toolTipRow1=(PAGE_OPTIONS.dataSet.xAxis.title+" "+catList[nearestPointIndex]);
              toolTipRow2=(PAGE_OPTIONS.dataSet.yAxis.title+" "+(PAGE_OPTIONS.dataSet.yAxis.prefix||"")+" "+dataSet[indx][nearestPointIndex]);
            }
            else{
              toolTipRow1="Projected";
              toolTipRow2=(PAGE_OPTIONS.dataSet.yAxis.title+" "+(PAGE_OPTIONS.dataSet.yAxis.prefix||"")+" "+projectedVal.toFixed(2));
            }
