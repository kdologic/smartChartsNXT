...
window.SmartChartsNXT = new function(){
  ...
  this.ui.toolTip = function(targetElem,cPoint,color,line1,line2)
  {
    ...
    var svgWidth = containerDiv.offsetWidth, svgHeight = containerDiv.offsetHeight;
    var strContents = "";
    ...
    var containBox = {width:temp.offsetWidth+6,height:temp.offsetHeight};
    ...
    var width = txtWidth+(2*padding),height=lineHeight+(2*padding);
    var d = [
    ...
    var tooTipHTML = toolTipGrp.querySelector("#toolTipHTML"),textPos;
    if(tooTipHTML){
  ...
  this.ui.appendMenu2 = function (targetElem,svgCenter,scaleX,scaleY){
    ...
    function onMenuClick(e){
      ...
      if(menuSidePanel.length > 0)
      {
        ...
        var menuItemWidth = 100,menuHeight = 30,offSetX = 10,offSetY = 20;//offSetX = ((svgCenter.x)-350+(scaleX/2)),offSetY = (25-(scaleY/2));
