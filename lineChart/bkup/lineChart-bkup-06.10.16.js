...
window.SmartChartsNXT.LineChart = function(opts)
{
  ...
  function createSeries(dataSet,index,scaleX)
  {
    ...
    strSeries +="<path id='line_"+index+"' stroke='"+$SC.util.getColor(index)+"' fill='none' d='"+line.join(" ")+"' stroke-width='2' opacity='1'></path>";
    ...
    try{
      ...
      { 
        ...
        if(toolTipPoint)
        {
          ...
          $SC.geom.createDot(toolTipPoint,"#FFF",6,1,"tooTipPoint","lineChart",$SC.util.getColor(indx));
          $SC.geom.createDot(toolTipPoint,$SC.util.getColor(indx),4,1,"tooTipPoint","lineChart");
